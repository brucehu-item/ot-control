...
export const overtimeApi = {
  ...
  createOvertimeRequest: async (requestData) => {
    const response = await axiosInstance.post('/overtime-requests', requestData)
  ...
  getOvertimeRequestDetails: async (requestId) => {
    const response = await axiosInstance.get(`/overtime-requests/${requestId}`)
    return response.data
  },
  ...
  cancelOvertimeRequest: async (requestId) => {
    const response = await axiosInstance.post(`/overtime-requests/${requestId}/cancel`)
    return response.data
  }
} 